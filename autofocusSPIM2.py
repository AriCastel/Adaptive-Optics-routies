...
from auxiliarySPIM2 import metrics
...
def Autofocus1():
    ...
    p1= np.arange(-PF,PI,d)
    p2= np.arange(PI,PF+d,d)
    ...
    for i in range(p.size):
        ...
        m[i]=metrics.DCTS(np.reshape(tagged_image.pix,newshape=[tagged_image.tags['Height'], tagged_image.tags['Width']]))
